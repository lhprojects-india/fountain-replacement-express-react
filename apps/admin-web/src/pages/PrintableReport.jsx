...
import { driverServices, LaundryheapLogo, Button, PRODUCT_DISPLAY_NAME, ProductBrandHeading } from "@lh/shared";
        ...
        <div className="min-h-screen bg-white printable-report-container">
            ...
            <div className="max-w-[210mm] mx-auto p-8 print:p-0">
                <div className="flex justify-between items-center mb-8 print:mb-4">
                    ...
                    <div className="text-right">
                        ...
                        <ProductBrandHeading
                            ...
                            mainClassName="text-sm font-semibold text-gray-700"
                            bylineClassName="text-xs text-gray-500 mt-0.5"
                        />
                ...
                <div className="mt-8 text-center text-xs text-gray-400 print:mt-auto print:pt-4">
                    <p>Generated by {PRODUCT_DISPLAY_NAME}</p>
                </div>
            </div>
        </div>
    );
