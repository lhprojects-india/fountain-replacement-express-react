const LaundryheapLogo = () => {
  return (
    <div className="flex flex-col justify-center items-center py-4 md:py-8 pt-[max(1rem,env(safe-area-inset-top))]">
      <div className="animate-slide-down w-20 h-20 md:w-24 md:h-24">
        <svg
          width="96"
          height="96"
